...
public class Alerts {
    ...
    public static class CustomAlert {
        ...
        public static class WarningAlert extends BaseAlert {
             ...
             * @RUNTIME_ERROR NULLPOINTEREXCEPTION - This error was encountered a few times throughout the project. In this instance, the Alert was not created before the extended classes tried to use the BaseAlert. To fix the issue, I instantiated the Alert in BaseAlert upon declaration.
             */
         ...
         */
        public static class ConfirmationAlert extends BaseAlert {
            /**
             * The Command.
             */
